...
export const SITE = {
  ...
  description:
    "Renew trade licenses, visas, Emirates IDs and corporate documents across the UAE. Dubai-based CSP with clear pricing from AED 299, transparent government fees and expiry reminders.",
  shortDescription:
    "UAE renewals made simple — licenses, visas, Emirates IDs and corporate documents across all 7 Emirates. Clear quotes from AED 299.",
  abstract:
    "Certified Corporate Service Provider in Dubai for UAE trade license, visa, Emirates ID and corporate document renewals with transparent fee breakdowns.",
  locale: "en_AE",
  language: "en",
  ...
  keywords: [
    ...
    "Renew-It Dubai",
    "renew it ae",
    "UAE document renewal service",
    "trade license renewal AED 299",
    "Dubai Department of Economy and Tourism partner",
    "family visa renewal Dubai",
    "dependent visa renewal UAE",
    "employee visa renewal Dubai",
    "partner visa renewal UAE",
    "Ajman license renewal",
    "Ras Al Khaimah visa renewal",
    "Fujairah company renewal",
    "UAE expiry reminders",
    "transparent government fees Dubai",
  ],
